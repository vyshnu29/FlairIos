  ...
  return (
    <Container>
      ...
      <FlatList
        ...
        renderItem={({item}) => {
          return (
            <Card noShadow style={{elevation:0,borderRadius:16,width:'96%',alignSelf:'center'}}>
            <List>
              <ListItem avatar noBorder>
                ...
                <Body>
                  ...
                  <Title style={{color: '#62B1F6', fontSize: 16,fontWeight:'400',bottom:5}}>{metaInfo.toNameCase(item.actionbyName)}</Title>
                  </TouchableOpacity>
